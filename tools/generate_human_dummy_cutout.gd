extends SceneTree
## Generates dev-only placeholder cutout PNGs (_dummy set). Not for production.
## Run: godot --headless --path . --script res://tools/generate_human_dummy_cutout.gd

const _ROOT := "res://assets/visuals/parts/human/male/_dummy"
...
func _initialize() -> void:
	...
	print("generate_human_dummy_cutout: done -> %s" % _ROOT)
	quit(0)
